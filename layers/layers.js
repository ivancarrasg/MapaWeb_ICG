...
jsonSource_Inventario_vect_3.addFeatures(features_Inventario_vect_3);
...
lyr_Canales_4.set('fieldImages', {'SEGMENT_ID': '', 'NODE_A': '', 'NODE_B': '', 'BASIN': '', 'ORDER': '', 'ORDER_CELL': '', 'LENGTH': '', 'CAUCE': '', });
...
lyr_Inventario_vect_3.set('fieldLabels', {'PARCELA': 'no label', 'Y': 'no label', 'X': 'no label', 'Nparc': 'no label', });
lyr_Canales_4.set('fieldLabels', {'SEGMENT_ID': 'no label', 'NODE_A': 'no label', 'NODE_B': 'no label', 'BASIN': 'no label', 'ORDER': 'no label', 'ORDER_CELL': 'no label', 'LENGTH': 'no label', 'CAUCE': 'no label', });
